                                ...
                                <form  action="{{ route('assynment.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input readonly type="name" name="title" value="{{ old('title') }}" class="form-control" placeholder="Enter title">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input readonly type="name" name="my_class_id" value="{{ old('my_class_id') }}" class="form-control">
