                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-12 col-lg-8 offset-lg-2 col-md-8 offset-md-2">
                                <form  action="{{ route('assynment.update', $assynment->id) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select onchange="getClassSubjects(this.value)" data-placeholder="Choose..." name="my_class_id" id="my_class_id" class="select-search form-control">
                                                ...
                                                @foreach($my_classes as $c)
                                                    <option {{ (old('my_class_id') == $c->id || $assynment->my_class_id ==  $c->id   ? 'selected' : '') }} value="{{ $c->id }}">{{ $c->name }}</option>
                                                    @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
