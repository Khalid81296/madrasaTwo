    ...
    <div class="card-body">
        <form action="{{ route('expenses.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('expense_category_id') ? 'has-error' : '' }}">
                ...
                <select onchange="teacherSal(this)" name="expense_category_id" id="expense_category" class="form-control select2">
            ...
            <div class="form-group {{ $errors->has('amount') ? 'has-error' : '' }}">
                ...
                <input type="text" id="amount" name="amount" class="form-control" value="{{ old('amount', isset($expense) ? $expense->amount : '') }}" step="0.01" required>
