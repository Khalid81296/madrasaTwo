...
@section('page_title', 'Admit Badrins')
@section('content')
        <div class="card">
            <div class="card-header bg-white header-elements-inline">
                <h6 class="card-title">Please fill The form Below To Admit A New Badrins</h6>

                {!! Qs::getPanelOptions() !!}
            </div>

            <form id="ajax-reg" method="post" enctype="multipart/form-data" class="wizard-form steps-validation" action="{{ route('badrins.store') }}" data-fouc>
               @csrf
                <h6>Personal data</h6>
                <fieldset>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Member No: <span class="text-danger">*</span></label>
                                <input value="{{ old('member_no') }}" type="text" name="member_no" class="form-control" placeholder="Member No" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input value="{{ old('phone') }}" type="text" name="phone" class="form-control" placeholder="mobile_no" required>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" name="nal_id" value="15">
                        <input type="hidden" name="state_id" value="6">
                        <input type="hidden" name="lga_id" value="47">
                        <!-- <div class="col-md-4">
                            <div class="form-group">
                ...
                <fieldset>
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="my_class_id">User Type: <span class="text-danger">*</span></label>
                    ...
                    <div class="row" id="payment_add">
                        <div class="col-md-4  p-3 border">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input name="title[]" value="{{ old('title') ?? 'Badrin Fee' }} " required type="text" class="form-control" placeholder="Eg. Admission Fee">
                                    </div>
                                </div>
                                <div class="form-group row">
