...
@section('page_title', 'Edit Badrin')
@section('content')
        ...
        <div class="card">
            ...
            <form method="post" enctype="multipart/form-data" class="wizard-form steps-validation ajax-update" data-reload="#ajax-title" action="{{ route('badrins.update', Qs::hash($sr->id)) }}" data-fouc>
                @csrf @method('PUT')
                <h6>Personal data</h6>
                <fieldset>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input value="{{ $sr->member_no  }}" type="text" name="member_no" class="form-control" placeholder="Member No" >
                            </div>
                        </div>
                ...
                <fieldset>
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="my_class_id">User Type: </label>
