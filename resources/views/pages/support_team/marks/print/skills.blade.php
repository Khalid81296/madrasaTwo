<div>
    ...
    <div style="float: left">
        ...
        <span>15 - Excellent</span> <br>
        <span>12 - Very Good</span> <br>
        <span>9 - Good</span> <br>
        <span>6 - Fair</span> <br>
        <span>3 - Poor</span> <br>
    </div>
    ...
    <table align="left" style="width:35%; border-collapse:collapse;border: 1px solid #000;  margin: 10px 20px; display: none;" border="1">
        <thead>
        <tr>
