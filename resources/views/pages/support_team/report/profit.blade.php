								...
								<table class="table table-hover table-bordered report">
									<thead class="headding">
										<tr>
											...
											<th class="text-center" >আয়ের উৎস</th>
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-center" > টিউশন ফি </td>
											<td class="text-center" >সকল শিক্ষার্থীর টিউশন ফি</td>
										...
										<tr style="background-color: gray;">
											<td class="text-center" colspan="3"> মোট আয় </td>
							...
							<div class="col-6">	
								<table class="table table-hover table-bordered report">
									<thead class="headding">
										<tr>
											<th class="text-center" width="50" >ক্রম</th>
											<th class="text-left" > ব্যয়ের খাত</th>
											<th class="text-center" >বিস্তারিত </th>
											<!-- <th class="text-center" >তারিখ </th> -->
											<th class="text-center" >ব্যয়ের পরিমান </th>
										</tr>
									...
									<tbody>
										...
										@endforeach
										<tr style="background-color: gray;">
											<td class="text-center" colspan="3"> মোট ব্যয়</td>
						...
						<div class="row">
							<div class="col-12" >
								...
								<table class="table table-hover table-bordered report mt-5"  style="margin-left: auto; margin-right: auto; width: 250px;">
									...
									<tr>
										<td class="text-center">  মোট ব্যয়</td>
										<td class="text-center"> {{ $grandtotalAmountExpence }} </td>
									</tr>
									<tr>
										<td class="text-center">মোট ব্যালেন্স </td>
