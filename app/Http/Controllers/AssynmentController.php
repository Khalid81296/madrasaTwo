...
class AssynmentController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        // return Auth::user()->student_record->my_class_id;

        if(Auth::user()->user_type == 'student'){
            $data['assynments'] = Assynment::orderBy('id', 'DESC')->where('my_class_id', Auth::user()->student_record->my_class_id)->paginate(20);
        } elseif(Auth::user()->user_type == 'teacher'){
            $data['assynments'] = Assynment::orderBy('id', 'DESC')->where('user_id', Auth::user()->id)->paginate(20);
        } else{
            $data['assynments'] = Assynment::orderBy('id', 'DESC')->paginate(20);
        }
        $data['page_title'] = 'All assynment';
        return view('assynment.index')->with($data);
    }
    ...
    public function create()
    {
        ...
        $d['selected'] = false;
        $d['page_title'] = 'Create assynment';
        return view('assynment.create')->with($d);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(Assynment $Assynment)
    {
        // return $Assynment;
        $page_title = 'Show Assynment';
        return view('assynment.show', compact('Assynment', 'page_title'));
    }
    ...
    public function edit(Assynment $assynment)
    {
        ...
        return view('assynment.edit')->with($d);
        // return $assynment;
        // return view('assynment.edit', compact(['assynment']));
    }
