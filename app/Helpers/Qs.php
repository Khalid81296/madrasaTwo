...
class Qs
{
    ...
    {
        return self::getSetting('system_title') ?: 'DIM';
    }
 ...
 <div class="alert alert-success alert-bordered">
    ...
    {
        $data = ['name', 'father', 'occupation', 'sup_teacher', 'present_address', 'email', 'phone', 'phone2', 'dob', 'gender', 'address', 'bg_id', 'nal_id', 'state_id', 'lga_id'];
    ...
    public static function getBadrinData($remove = [])
    {
        $data = ['my_class_id', 'section_id', 'my_parent_id', 'dorm_id', 'dorm_room_no', 'member_no', 'year_admitted', 'house', 'age'];
    ...
    public static function userIsBadrin()
    {
        return Auth::user()->user_type == 'badrin';
    }
    ...
    {
        $data =  ['super_admin', 'admin', 'teacher', 'accountant', 'librarian', 'student', 'badrin', 'parent'];
        return $remove ? array_values(array_diff($data, $remove)) : $data;
    }
    ...
    public static function findBadrinRecord($user_id)
    {
        return BadrinRecord::where('user_id', $user_id)->first();
    }
